...
export default function HomeHero() {
  return (
    <div className="relative max-w-4xl">
      ...
      >
        Say the
        <span className="block font-display text-[0.98em] font-medium italic leading-[0.86] tracking-[-0.035em] text-[#F2C7CF] drop-shadow-[3px_3px_0_rgba(139,92,246,0.55)]">thing.</span>
      </motion.h1>
