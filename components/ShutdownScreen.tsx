...
export default function ShutdownScreen({ message }: { message: string }) {
  return (
    <main className="site-grid flex min-h-screen flex-col items-center justify-center px-6 py-16 text-center">
      ...
      {/* Renders nothing unless the admin has both a poll open AND has
          separately toggled "show during shutdown" on it. */}
      <PollWidget context="shutdown" />
    </main>
  );
}
