...
export default function QRCodeCard() {
  ...
  return (
    <div className="relative rotate-1 rounded-note bg-paper p-6 text-ink shadow-[0_12px_0_rgba(0,0,0,0.25)]">
      ...
      <div ref={canvasWrapRef} className="inline-block rounded bg-white p-3">
        <QRCodeCanvas value={url} size={168} fgColor="#1B1B2F" level="M" />
      </div>
