...
export default function ConfessionCard({
  ...
  return (
    <article
      className={`pin relative rounded-note bg-paper p-6 text-ink shadow-[0_10px_0_rgba(0,0,0,0.22)] transition ${
    ...
    >
      ...
      <div className="mt-5 flex items-center gap-2">
        ...
        <button
          ...
          className="rounded-full px-3 py-1.5 text-sm text-roseDeep transition hover:bg-roseDeep/10"
        >
        ...
        {isAdmin && (
          <button
            ...
            disabled={busy}
            className="rounded-full px-3 py-1.5 text-sm text-slateInk/60 transition hover:bg-ink/5 hover:text-roseDeep"
          >
            delete
          </button>
        )}
