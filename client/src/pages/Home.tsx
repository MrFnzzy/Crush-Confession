...
export default function Home() {
  ...
  const handleViewChange = (newView: "wall" | "confess") => {
    setView(newView);
    setLocation(newView === "confess" ? "/confess" : "/");
  };
              ...
              <DialogContent className="sm:max-w-md">
                ...
                <div className="flex flex-col items-center justify-center p-6 gap-4">
                  <div className="bg-white p-4 rounded-2xl shadow-sm border">
                    <img 
                      src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(window.location.origin + "/confess")}`} 
                      alt="QR Code" 
                      className="w-48 h-48"
                    />
                  </div>
                  ...
                  <Button 
                    ...
                    className="w-full"
                    onClick={() => {
                      navigator.clipboard.writeText(window.location.origin + "/confess");
