...
export default async function WallPage({
  ...
  // Number confessions by creation order (oldest = #001), independent of
  // the current sort — so numbering stays stable and gap-free even after
  // older confessions are deleted, instead of jumping around with the
